...
- **planner**: disponibilidad semanal pintable (tap = una celda, arrastre con umbral),
  mapa de calor y resumen «quién puede», validación de bloques (≥1,5h), authz de API
  entre grupos, paridad `/g/[slug]/planificador`.
