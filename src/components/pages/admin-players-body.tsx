  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-3">
        ...
        <Link href={`${basePath}/admin/players/new`} className="lpt-btn primary shrink-0" style={{ minHeight: 38, padding: '7px 13px', fontSize: 12.5 }}>
                  ...
                  <TableRow key={player.id}>
                    ...
                    <TableCell>
                      <div className="flex gap-1 justify-end">
                        <Link href={`${basePath}/admin/players/${player.id}/edit`} aria-label={`Editar a ${player.name}`}>
