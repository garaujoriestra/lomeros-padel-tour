...
// Réplica de admin/pozos/[id]/page.tsx (Task 7, paridad 2b).
export default async function GroupAdminPozoDetailPage({ params }: { params: Promise<{ slug: string; id: string }> }) {
